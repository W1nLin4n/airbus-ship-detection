...
def build_model():
    ...
    c1 = layers.Conv2D(8, 3, activation="relu", padding="same")(input)
    ...
    c4 = layers.Conv2D(64, 3, activation="relu", padding="same")(p3)
    c4 = layers.Conv2D(64, 3, activation="relu", padding="same")(c4)
    p4 = layers.MaxPooling2D()(c4)

    c5 = layers.Conv2D(128, 3, activation="relu", padding="same")(p4)
    ...
    c8 = layers.Conv2D(16, 3, activation="relu", padding="same")(u8)
    c8 = layers.Conv2D(16, 3, activation="relu", padding="same")(c8)

    u9 = layers.Conv2DTranspose(16, 3, strides=2, padding="same")(c8)
    u9 = layers.concatenate([u9, c1])
    c9 = layers.Conv2D(8, 3, activation="relu", padding="same")(u9)
    c9 = layers.Conv2D(8, 3, activation="relu", padding="same")(c9)
